...
IOTC_CONFIG_FLAGS += -DALT_ECC_SIZE 
#IOTC_CONFIG_FLAGS += -DDEBUG_WOLFSSL
IOTC_CONFIG_FLAGS += -DECC_SHAMIR
IOTC_CONFIG_FLAGS += -DECC_TIMING_RESISTANT
...
#IOTC_CONFIG_FLAGS += -DHAVE_THREAD_LS
IOTC_CONFIG_FLAGS += -DHAVE_TLS_EXTENSIONS
#IOTC_CONFIG_FLAGS += -DHAVE___UINT128_T
#IOTC_CONFIG_FLAGS += -DNO_DES
#IOTC_CONFIG_FLAGS += -DNO_DES3
#IOTC_CONFIG_FLAGS += -DNO_DH
IOTC_CONFIG_FLAGS += -DNO_DSA
IOTC_CONFIG_FLAGS += -DNO_ERROR_STRINGS
#IOTC_CONFIG_FLAGS += -DNO_FILESYSTEM
...
IOTC_CONFIG_FLAGS += -DUSER_TIME=1
IOTC_CONFIG_FLAGS += -DWC_RSA_BLINDING
IOTC_CONFIG_FLAGS += -DWOLFSSL_BASE64_ENCODE
IOTC_CONFIG_FLAGS += -DWOLFSSL_KEY_GEN
...
IOTC_CONFIG_FLAGS += -DWOLFSSL_SMALL_STACK_CACHE
IOTC_CONFIG_FLAGS += -DWOLFSSL_STATIC_RSA
#IOTC_CONFIG_FLAGS += -DWOLFSSL_X86_64_BUILD
IOTC_CONFIG_FLAGS += -DSIZEOF_LONG_LONG=8
IOTC_CONFIG_FLAGS += -DNO_DEV_RANDOM
IOTC_CONFIG_FLAGS += -DUSE_CERT_BUFFERS_2048
IOTC_CONFIG_FLAGS += -DHAVE_ALPN
IOTC_CONFIG_FLAGS += -DUSE_WOLF_STRTOK
